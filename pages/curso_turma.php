<?php
  ...
  global $CFG, $DB;
  $titulo = 'Cursos e Turmas por Ciclo';

  $PAGE->set_url($_SERVER['PHP_SELF']);
  $PAGE->set_pagelayout('admin');
  $PAGE->set_context(context_system::instance());
  $PAGE->set_url('/blocks/moodleversion/pages/curso_turma.php');
  $PAGE->navbar->add($titulo, new moodle_url("$CFG->httpswwwroot/blocks/moodleversion/pages/curso_turma.php"));
  echo $OUTPUT->header();
?>
